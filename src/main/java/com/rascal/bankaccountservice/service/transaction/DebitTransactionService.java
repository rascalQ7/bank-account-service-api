...
public class DebitTransactionService implements TransactionService {
  ...
  public DebitTransactionService(
      ...
      @Qualifier("debitValidator") TransactionValidator validator
  ) {
  ...
  /**
   * If active account exists, validates transaction against account state and debits transaction
   * @param transaction - transaction instructions
   */
  @Override
  @Transactional
